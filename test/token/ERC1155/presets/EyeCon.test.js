...
const EyeCon = artifacts.require('EyeCon');

contract('EyeCon', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await EyeCon.new(uri, { from: deployer });
  });
  ...
  describe('minting', function () {
    ...
    it('other accounts cannot mint tokens', async function () {
      await expectRevert(
        ...
        'EyeCon: must have minter role to mint',
      );
    });
  });
  ...
  describe('pausing', function () {
    ...
    it('other accounts cannot pause', async function () {
      await expectRevert(
        ...
        'EyeCon: must have pauser role to pause',
      );
    });
    ...
    it('other accounts cannot unpause', async function () {
      ...
      await expectRevert(
        ...
        'EyeCon: must have pauser role to unpause',
      );
    });
  });
