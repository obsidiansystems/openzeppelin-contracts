...
const ERC721PresetMinterPauser = artifacts.require('ERC721PresetMinterPauser');

contract('ERC721PresetMinterPauser', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await ERC721PresetMinterPauser.new(name, symbol, baseURI, { from: deployer });
  });
